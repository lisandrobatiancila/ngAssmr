...
destroyEvents:
function(){
    var t,e;for(J.prototype.destroyEvents.call(this),t=this.rowStructs||[];e=t.pop();)e.tbodyEl.remove();
...
function(t,e){
    ...
    t.isStart && (d='<span class="fc-time">'+R(n.getEventTimeText(o))+"</span>"),
    i='<span class="fc-title asd1">'+(R(o.title||"")||"&nbsp;")+"</span>",
    e='<span class="fc-resched"></span>',

    f='<a class="'+a.join(" ")+'"'+(o.url?' href="'+R(o.url)+'"':"")+(c?' style="'+c+'"':"")+">"+
            '<div class="fc-content modifiedJoseph">'+
                (r?i+" "+d:d+" "+i)+
            "</div>"+
            (l?'<div class="fc-resizer"/>':"")+
        "</a>",

    g= '<a class="'+a.join(" ")+'"'+(o.url?' href="'+R(o.url)+'"':"")+(c?' style="'+c+'"':"")+">"+
            '<div class="fc-content modifiedJoseph">'+
                '<div class="fc-resched" style="border-top-style:solid; border-top-color:#FFFF00">'+
                    (r?i+" "+d:d+" "+i)+
                 "</div>"+
            "</div>"+
            (l?'<div class="fc-resizer"/>':"")+
